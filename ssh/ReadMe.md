...
Вариант № 6: В строке приглашения вывести системную дату и время.
Вошли в Малину. Файл "Vhod"
Создали дерево используя команды (mkdir/ ls/ cd/ cd ../). Фото "Tree" и "Tree2"
Вывели системные дату и время используя команду (date). Фото "Date"
